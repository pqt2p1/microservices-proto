...
const file_payment_payment_proto_rawDesc = "" +
	"\n" +
	"\x15payment/payment.proto\x12\bshipping\"k\n" +
...
var file_payment_payment_proto_goTypes = []any{
	(*CreatePaymentRequest)(nil),  // 0: shipping.CreatePaymentRequest
	(*CreatePaymentResponse)(nil), // 1: shipping.CreatePaymentResponse
}
var file_payment_payment_proto_depIdxs = []int32{
	0, // 0: shipping.Payment.Create:input_type -> shipping.CreatePaymentRequest
	1, // 1: shipping.Payment.Create:output_type -> shipping.CreatePaymentResponse
